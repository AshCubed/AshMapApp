package com.vega.gade3.student17611612.ashmapapp.services;
...
public class LocationService extends Service {
        ...
        mFusedLocationClient.requestLocationUpdates(mLocationRequestHighAccuracy, new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                if (location != null) {
                    ...
                    UserLocationClass userLocation = new UserLocationClass(geoPoint, null, currentUser);
    ...
    private void saveUserLocation(final UserLocationClass userLocation){
